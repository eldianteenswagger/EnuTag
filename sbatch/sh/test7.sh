...
#SBATCH --licenses=sps
#SBATCH --time=4:00:00
#SBATCH --job-name=ENUTAGt7
#SBATCH --output=/sps/gdrnu/lzappacosta01/LOG/logtest7.out
#SBATCH --error=/sps/gdrnu/lzappacosta01/LOG/logtest7.err
...
cp /sps/gdrnu/lzappacosta01/EnuTag/sbatch/macros/run7.mac .
main run7.mac
