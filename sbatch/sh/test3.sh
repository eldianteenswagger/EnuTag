...
#SBATCH --output=/sps/gdrnu/lzappacosta01/LOG/logtest3.out
#SBATCH --error=/sps/gdrnu/lzappacosta01/LOG/logtest3.err
...
cp /sps/gdrnu/lzappacosta01/EnuTag/sbatch/macros/run3.mac .
main run3.mac
