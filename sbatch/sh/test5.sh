...
#SBATCH --licenses=sps
#SBATCH --time=4:00:00
#SBATCH --job-name=ENUTAGt5
#SBATCH --output=/sps/gdrnu/lzappacosta01/LOG/logtest5.out
#SBATCH --error=/sps/gdrnu/lzappacosta01/LOG/logtest5.err
...
cp /sps/gdrnu/lzappacosta01/EnuTag/sbatch/macros/run5.mac .
main run5.mac
