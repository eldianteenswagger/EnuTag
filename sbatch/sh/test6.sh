...
#SBATCH --licenses=sps
#SBATCH --time=4:00:00
#SBATCH --job-name=ENUTAGt6
#SBATCH --output=/sps/gdrnu/lzappacosta01/LOG/logtest6.out
#SBATCH --error=/sps/gdrnu/lzappacosta01/LOG/logtest6.err
...
cp /sps/gdrnu/lzappacosta01/EnuTag/sbatch/macros/run6.mac .
main run6.mac
