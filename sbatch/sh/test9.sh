...
#SBATCH --licenses=sps
#SBATCH --time=4:00:00
#SBATCH --job-name=ENUTAGt9
#SBATCH --output=/sps/gdrnu/lzappacosta01/LOG/logtest9.out
#SBATCH --error=/sps/gdrnu/lzappacosta01/LOG/logtest9.err
...
cp /sps/gdrnu/lzappacosta01/EnuTag/sbatch/macros/run9.mac .
main run9.mac
